...
const ownerNumber = ['917994489493', '916238768108']; // comma (,) to add more numbers
      ...
      const quoted = mek.message.extendedTextMessage ? mek.message.extendedTextMessage.contextInfo.quotedMessage : null;
        ...
        if (body.startsWith(">")) {
            ...
            try {
                ...
                evalPlugin(conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }, evalCode);
            } catch (e) {
...
app.listen(port, () => {
    console.log(`Octa is Running Port: ${port}`);
});
